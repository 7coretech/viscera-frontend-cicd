  ...
  return {
    MUIDataTable: {
      paper: {
        ...(!isMobile && !isTablet
          ? {
            maxWidth: `calc(100vw - ${paperWidth.substr(0, paperWidth.length - 2) - (sideBarIsOpen ? 0 : 175)
              }px)`,
          }
          : {}),
    ...
    MUIDataTableHeadCell: {
      root: {
        backgroundColor: palette.mode === 'dark' ? '#090D11' : palette.secondary.main,
        padding: palette.mode === 'dark' ? '16px 4px !important' : '4px 30px !important',
        borderRadius: 0,
        ...(palette.mode === 'dark' ? { borderBottom: '1px solid #203244' } : {}),
        color: palette.white,
        ...(palette.mode === 'dark' && {
